  ...
  pages: {
    ...
    exp: {
      ...
      cards:
        [
          {
            position: "DevOps Specialization",
            company: "IES San Clemente",
            date: "September 2026 - June 2027",
            description: "Container deployment and DevOps methodology.",
            responsibilities: [
              "Cloud and On-premise architectures with containers",
          ...
          {
            position: "24/7 Support Technician",
            company: "Dinahosting",
            date: "September 2026 - Present",
            description: "Technical support for hosting and domain customers.",
            responsibilities: [
              "Customer support via phone, email, and chat",
              "Technical incident resolution on servers",
              "Basic administration of Linux, Apache, and Postfix",
              "Support for network protocols and CMS (WordPress, PrestaShop)"
            ],
            alt: "Dinahosting Logo",
            imgPath: "/images/experience/dinahosting.jpg"
          },
          {
            position: "24/7 Helpdesk Technician",
            company: "Audasa",
            date: "June - September 2026",
            description: "Helpdesk Technician on the AP-9 highway",
            responsibilities: [
              "Incident management",
              "Station supervision",
              "Customer service"
          ...
          },
          {
            ...
            description: "Development of a customized business CRM.",
            responsibilities: [
              "FullStack development with Laravel and Angular",
              "Database management and business logic",
              "Improvement of internal processes in proprietary CRM",
